        ...
        >
          {COUNTRIES.map(c => (
            ...
            >
              ...
              <span style={{ color: '#F5F0E8' }}>{c.label}</span>
            </button>
          ))}
        </div>
      )}
    ...
    <div style={{ position: 'relative' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <button onClick={() => setOpen(false)} aria-label="Close guestbook"
              style={{ background: 'none', border: 'none', color: 'rgba(245,240,232,0.4)', cursor: 'pointer', fontSize: '16px', padding: '0 0.25rem', lineHeight: 1 }}>
              ×
            </button>
          </div>
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '0.25rem 1rem' }}>
            {loading ? (
              ...
              <div style={{ fontFamily: 'var(--font-sans)', fontSize: '13px', color: 'var(--color-muted, #7A7268)', padding: '2rem 0', textAlign: 'center' }}>
                Be the first to leave a mark.
              </div>
            ) : (
              entries.map((e, i) => (
                <div key={i} style={{ padding: '0.6rem 0', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                  <div style={{ fontFamily: 'var(--font-sans)', fontSize: '12px', color: 'rgba(245,240,232,0.82)', lineHeight: 1.4 }}>
                    {e.country} <strong style={{ color: '#F5F0E8' }}>{e.name}</strong> — {e.message}
                  </div>
                  <div style={{ fontFamily: 'var(--font-mono)', fontSize: '9px', color: 'rgba(245,240,232,0.28)', marginTop: '0.15rem', letterSpacing: '0.04em' }}>
                    {fmtDate(e.date)}
                  </div>
                </div>
              ))
            ...
            {submitted ? (
              ...
              <>
                ...
                <button type="submit" disabled={submitting} style={{
                  ...
                  color: '#100D0A', border: 'none', borderRadius: '9999px',
      ...
      <button
        ...
        style={{
          ...
          background: 'rgba(16,13,10,0.82)', backdropFilter: 'blur(12px)',
