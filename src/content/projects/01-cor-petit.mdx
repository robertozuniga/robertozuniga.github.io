...
foundation that brought the original problem to the table. What
started as a 48-hour build became a real tool the foundation can
use to measure the emotional impact of their hospital play sessions.
